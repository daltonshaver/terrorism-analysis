...
oef_hoa = pd.read_csv(r'C:\Users\dalto\Documents\KSU\Research_F22\datasets\oef_hoa.csv')
oef_p = pd.read_csv(r'C:\Users\dalto\Documents\KSU\Research_F22\datasets\oef_p.csv')
oef_ts = pd.read_csv(r'C:\Users\dalto\Documents\KSU\Research_F22\datasets\oef_ts.csv')

# Loading in newly created probability datasets.
prob_hoa = pd.read_csv(r'C:\Users\dalto\Documents\KSU\Research_F22\datasets\prob_hoa.csv')
prob_p = pd.read_csv(r'C:\Users\dalto\Documents\KSU\Research_F22\datasets\prob_p.csv')
prob_ts = pd.read_csv(r'C:\Users\dalto\Documents\KSU\Research_F22\datasets\prob_ts.csv')
...
def point_plots():
    ...
    # SUICIDE
    plt.figure(figsize=(6, 6.5))  # (6, 7) Analytics Day, (6, 6.5) C-Day, (6, 6.5) Harvard
    ...
    plt.ylabel(ylab, fontsize=font_size_labels)
    plt.grid(axis='both', color='gray', linestyle='dashed', alpha=0.3)
    plt.title("Figure 6: Point Plot of Median Predicted\nProbabilities of Success for\nCity Vicinity by Mission",
              fontsize=font_size_title)
    plt.show()

    # ATTACKTYPE
    plt.figure(figsize=(10, 5.5))  # (6, 6.5) Analytics Day, (13, 4.5) C-Day, (10, 5.5) Harvard
    ...
    plt.ylabel(ylab, fontsize=font_size_labels)
    plt.grid(axis='both', color='gray', linestyle='dashed', alpha=0.3)
    plt.title("Figure 4: Point Plot of Median Predicted Probabilities\nof Success for Attack Type by Mission",
              fontsize=font_size_title)
    plt.show()

    # WEAPTYPE
    plt.figure(figsize=(9, 4.5))  # (6, 6.5) Analytics Day, (6, 6.5) C-Day, (9, 4.5) Harvard
    ...
    # GNAME
    plt.figure(figsize=(9, 4.5))  # (13.5, 4) Analytics Day, (13, 4.5) C-Day, (9, 4.5) Harvard
    ...
    plt.ylabel(ylab, fontsize=font_size_labels)
    plt.grid(axis='both', color='gray', linestyle='dashed', alpha=0.3)
    plt.title("Figure 8: Point Plot of Median Predicted Probabilities of\nSuccess for Country by Mission",
              fontsize=font_size_title)
    plt.show()

    # TARGTYPE
    plt.figure(figsize=(13.5, 4))  # (13.5, 4) Analytics Day, (13, 4.5) C-Day, (10, 5.5) Harvard
    ...
    plt.ylabel(ylab, fontsize=font_size_labels)
    plt.grid(axis='both', color='gray', linestyle='dashed', alpha=0.3)
    plt.title("Figure 2: Point Plot of Median Predicted Probabilities\nof Success for Target Type by Mission",
              fontsize=font_size_title)
    plt.show()
